...
A client-side Fabric mod for Minecraft Java Edition **1.21.11** that exports all registered item, block, block entity type and entity type IDs to a JSON file.
