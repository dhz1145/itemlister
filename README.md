...
A client-side Fabric mod for Minecraft Java Edition **1.21.6–1.21.8** that exports all registered item, block, block entity type, entity type and fluid IDs to a JSON file.
